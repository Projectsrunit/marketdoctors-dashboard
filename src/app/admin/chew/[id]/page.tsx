...
const ChewSettingsPage = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error("Failed to delete CHEW");
      }

      toast.success("CHEW deleted successfully");
      // Redirect to CHEWs list
      window.location.href = "/admin/chew";
    } catch (error) {
      console.error("Error deleting CHEW:", error);
      toast.error("Failed to delete CHEW");
    }
  };
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="w-full max-w-md rounded-lg bg-white p-6 dark:bg-boxdark">
              ...
              <p className="mb-6 text-base">
                Are you sure you want to delete this CHEW? This action cannot be undone.
              </p>
